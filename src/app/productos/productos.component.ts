...
export class ProductosComponent {
  productos: Producto[] = [
    ...
    { "id": 2, "name": "Hamburguesa", "description": "Hamburguesa con carne jugosa", "price": 120, "image": "/UpsCoffee/hamburguesa.webp", "type": "Snack" },
    ...
    { "id": 8, "name": "Tacos", "description": "Tacos al pastor con piña y cebolla.", "price": 70, "image": "/UpsCoffee/tacos.webp", "type": "Mexicana" },
    { "id": 9, "name": "Sopa", "description": "Sopa de pollo con verduras y fideos.", "price": 85, "image": "/UpsCoffee/sopa.jpg", "type": "Saludable" },
    { "id": 10, "name": "Huevos", "description": "Huevos estrellados muy ricos.", "price": 45, "image": "/UpsCoffee/huevos.webp", "type": "Desayuno" },
    ...
    { "id": 17, "name": "Ceviche", "description": "Ceviche fresco con camarón y limón.", "price": 180, "image": "/UpsCoffee/ceviche.webp", "type": "Mexicana" },
